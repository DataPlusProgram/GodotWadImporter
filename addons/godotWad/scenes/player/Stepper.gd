...
export var stepHeight = 0.9 setget setRays
...
func setRays(val):
	...
	footRay.translation = Vector3(0,halfHeight,0)
	footRay.cast_to = Vector3(0,0,-colShape.radius*radiusExtension)
	
	kneeRay.translation = Vector3(0,kneeHeight,0)
	kneeRay.cast_to = Vector3(0,0,-colShape.radius*radiusExtension)
